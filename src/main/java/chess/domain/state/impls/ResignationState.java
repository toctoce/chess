...
public class ResignationState implements GameState {

    private final Color winnerColor;

    public ResignationState(Color winnerColor) {
    ...
    public GameStatus status() {
        if (winnerColor == Color.WHITE) {
            return GameStatus.RESIGNATION_WHITE_WIN;
        }
        return GameStatus.RESIGNATION_BLACK_WIN;
    }
}